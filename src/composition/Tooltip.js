...
function Tooltip(props) {
    return (
        ...
        <span className="Tooltip-content" style={{ color: props.color }}>{props.children}</span>
...
class TooltipClass extends React.Component {
    ...
    render() {
      ...
      return (
        <span className='Tooltip'>
          <span className='Tooltip-content' style={{ color: this.props.color }}>{this.props.children}</span>
